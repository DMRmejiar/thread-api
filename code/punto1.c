...
int main (int argc, char *argv[]) {
    ...
    if (argc == 3) 
    {
        ...
        for (int i = 0; i < (argc - 1); i++)
        {
            ...
            pthread_create (&threads_ids[i], NULL, (void *)factorial, &thread_args[i]);
    ...
    {
        printf ("Le falto ingresar datos o excedio el numero de datos.\n PD: sin datos no va a funcionar\n");
    }
    return 0;
}
